...
namespace SaboreIA.Services
{
    public class ReviewService : IReviewService
    {
        ...
        public async Task<ReviewDto?> UpdateAsync(long id, UpdateReviewDto updateReviewDto, long userId)
        {
            var review = await _reviewRepository.GetByIdAsync(id);
            if (review == null)
                return null;
        ...
        public async Task<ReviewDto?> UpdateReviewImageAsync(long id, IFormFile imageFile, long userId)
        {
            var review = await _reviewRepository.GetByIdAsync(id);
            if (review == null)
                return null;
