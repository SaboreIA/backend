...
namespace SaboreIA.Interfaces.Service
{
    public interface IReviewService
    {
        ...
        Task<ReviewDto?> UpdateAsync(long id, UpdateReviewDto updateReviewDto, long userId);
        Task<ReviewDto?> UpdateReviewImageAsync(long id, IFormFile imageFile, long userId);
