    ...
    public class ReviewController : ControllerBase
    {
        ...
        public async Task<ActionResult<ReviewDto>> Update(long id, [FromBody] UpdateReviewDto updateReviewDto)
        {
            ...
            try
            {
                ...
                var review = await _reviewService.UpdateAsync(id, updateReviewDto, long.Parse(userId));
                if (review == null)
                    return NotFound(new { message = "Review not found" });
        ...
        /// Somente o próprio autor da review pode fazer upload
        /// </summary>
        ...
        public async Task<ActionResult<ReviewDto>> UploadImage(long id, IFormFile imageFile)
        {
            ...
            try
            {
                ...
                var review = await _reviewService.UpdateReviewImageAsync(id, imageFile, long.Parse(userId));
                if (review == null)
                    return NotFound(new { message = "Review not found" });
        ...
        public async Task<ActionResult> Delete(long id)
        {
            ...
            try
            {
                var result = await _reviewService.DeleteAsync(id, long.Parse(userId));
                if (!result)
                    return NotFound(new { message = "Review not found" });
